    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.waimea_flux"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.waimea_flux.tests.tests"

        To run tests in the WaimeaFluxTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.waimea_flux.tests.tests.WaimeaFluxTestCase"

        To run only the test_if_tethys_platform_is_great function in the WaimeaFluxTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.waimea_flux.tests.tests.WaimeaFluxTestCase.test_if_tethys_platform_is_great"
...
class WaimeaFluxTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(WaimeaFlux)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(WaimeaFlux)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/waimea-flux/')  # The final '/' is essential for all pages/controllers
